let inventario = [];
inventario.push({nombre: "celular",categoria:"Electronica",precio:50000});
inventario.push({nombre: "zapatillas",categoria:"ropa",precio:40000});
...
console.log("nombres de los productos de electronic");
